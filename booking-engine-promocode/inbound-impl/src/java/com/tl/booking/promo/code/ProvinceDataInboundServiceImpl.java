...
@Service
public class ProvinceDataInboundServiceImpl implements ProvinceDataInboundService {

  private static final Logger LOGGER = LoggerFactory
      .getLogger(ProvinceDataInboundServiceImpl.class);
  ...
  @Override
  @KafkaListener(topics = KafkaTopic.PROVINCE)
  public void createProvinceData(String message) throws Exception {
    ...
    LOGGER.info("createProvinceData request message {}, mandatoryRequest {}", message,
        mandatoryRequest);
    ...
    LOGGER.info("createProvinceData response variableSources {}", variableSources);
  }
  ...
  private List<VariableSource> mapDataToProvince(String message, MandatoryRequest
    ...
    for (Map<String, String> data : JSONHelper.convertJsonInStringToObject(message,
      ...
      variableSource.setSourceType(VariableSourceTable.PROVINCE);
