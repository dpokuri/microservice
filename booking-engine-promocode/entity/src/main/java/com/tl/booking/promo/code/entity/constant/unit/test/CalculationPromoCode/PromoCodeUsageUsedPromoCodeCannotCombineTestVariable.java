...
public class PromoCodeUsageUsedPromoCodeCannotCombineTestVariable {
  ...
  public static String CODE = "PROMOCODEUSEDPROMONOTCOMBINE";
  ...
  private static final Set<String> getUsedPromoCodes() {
    ...
    usedPromoCodes.add(UsedPromoCodeCannotCombineTestVariable.CODE);
