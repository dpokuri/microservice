...
public class PromoCodeUsageOperatorNotValidTestVariable {
  ...
  private static final PromoCodeGroupRule getPromoCodeGroupRule() {
    ...
    promoCodeGroupRule.setPromoCodeRules(getBlankOperatorPromoCodeRules());
  ...
  public static String CODE = "PROMOCODEUSAGEOPERATORNOTVALID";
