...
public class PromoCodeUsagePeriodNotValidTestVariable {
  ...
  public static String CODE = "PROMOCODEUSAGEINVALIDCHANNELID";
  ...
  public static CampaignPeriod CAMPAIGN_PERIOD = new CampaignPeriodBuilder()
      .withStartDate(new Date()).withEndDate(new Date()).build();
  ...
  private static final PromoCodeDistribution getPromoCodeDistribution() {
    ...
    return new PromoCodeDistributionBuilder().withStoreId(CommonTestVariable.STORE_ID).withChannelId
        (channelIds).build();
  }
