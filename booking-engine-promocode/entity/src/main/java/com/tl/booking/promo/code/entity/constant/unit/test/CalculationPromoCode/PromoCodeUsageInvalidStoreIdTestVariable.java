...
public class PromoCodeUsageInvalidStoreIdTestVariable {
  ...
  public static String CODE = "PROMOCODEUSAGEINVALIDSTOREID";
  ...
  private static final PromoCodeDistribution getPromoCodeDistribution() {
    ...
    return new PromoCodeDistributionBuilder().withStoreId("asal").withChannelId(channelIds).build();
  }
