...
public class PromoCodeUsageNoPromoCodeUsageExistedTestVariable {
  ...
  public static Double MAX_COMPANY_COST = 10000.00;
  public static Double MAX_PARTNER_COST = 10000.00;
  ...
  public static PromoCodeUsage PROMO_CODE_USAGE = new PromoCodeUsageBuilder()
      ...
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_NO_COUNT = new PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withStartDate(START_DATE)
      .withEndDate(END_DATE)
  ...
  public static PromoCodeUsage PROMO_CODE_USAGE_GENERAL = new PromoCodeUsageBuilder()
      ...
      .withUsername("*")
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_DAILY_NO_COUNT = new PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withStartDate(START_DATE_1)
      .withEndDate(START_DATE_1)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_GENERAL_NO_COUNT = new PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withStartDate(START_DATE)
      .withEndDate(END_DATE)
