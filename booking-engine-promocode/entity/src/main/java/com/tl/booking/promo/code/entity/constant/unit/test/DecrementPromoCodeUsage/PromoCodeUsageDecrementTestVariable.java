package com.tl.booking.promo.code.entity.constant.unit.test.DecrementPromoCodeUsage;
...
public class PromoCodeUsageDecrementTestVariable {

  public static final String CARD_NUMBER = "asdfghjklsadfgh";
  ...
  public static Double DISCOUNT_AMOUNT = 12000.00;
  ...
  public static String CODE = "PROMOCODEDECREMENT";
...
//      .withId(ID)
  ...
  public static PromoCode PROMO_CODE_REQUEST = new PromoCodeBuilder()
      ...
      .withCampaignId(CAMPAIGN_ID)
      .build();
  public static final String PROMO_CODE_USAGE_ID = "UU11";
  ...
  public static PromoCodeUsage PROMO_CODE_USAGE_GENERAL = new PromoCodeUsageBuilder()
      ...
      .withId(PROMO_CODE_USAGE_ID)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_GENERAL_FOR_DECREMENT = new PromoCodeUsageBuilder()
      .withPromoCode(CODE)
      .withPromoCodeId(ID)
      .withUsageCount(10)
      .withStartDate(START_DATE_EXPIRED)
      ...
      .withId(PROMO_CODE_USAGE_ID)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_DAILY_FOR_DECREMENT = new PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withUsageCount(10)
      .withStartDate(START_DATE_1)
      ...
      .withId(PROMO_CODE_USAGE_ID)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_DAILY_FOR_DECREMENT_CARD_NUMBER = new
      ...
      .withId(PROMO_CODE_USAGE_ID)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_FOR_DECREMENT = new PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withUsageCount(10)
      .withStartDate(START_DATE_EXPIRED)
      ...
      .withId(PROMO_CODE_USAGE_ID)
      .build();
  public static PromoCodeUsage PROMO_CODE_USAGE_FOR_DECREMENT_CARD_NUMBER = new
      PromoCodeUsageBuilder()
      .withPromoCode(PROMO_CODE.getCode())
      .withPromoCodeId(PROMO_CODE.getId())
      .withUsageCount(10)
