...
public class VariableServiceTestVariable {
  ...
  public static String CACHE_KEY = CacheKey.VARIABLE + "-" + CommonTestVariable.STORE_ID + "-" + ID;
  public static String CACHE_KEY_ALL = CacheKey.VARIABLE + "-" + CommonTestVariable
      .STORE_ID;
  public static String CACHE_KEY_MAPPED = CacheKey.VARIABLE_MAPPED + "-" + CommonTestVariable
      .STORE_ID;

  public static List<String> ALLOWED_ARITH = Arrays.asList("test1", "test2");

  public static String PRODUCT_TYPE_DTO = "12345678564321s";
  ...
  public static Map<String, Variable> VARIABLE_MAPPED = convertToMap();
  ...
  private static Map<String, Variable> convertToMap() {
    Map<String, Variable> variableMap = new HashMap<>();
    variableMap = new HashMap<>();
    for (Variable variable : VARIABLE_MAP) {
