package com.tl.booking.promo.code.entity.constant.unit.test.ApplyPromoCode;
...
public class PromoCodeUsageApplyPromoCodeTestVariable {

  public static final String CARD_NUMBER = "1231234545";
  public static final String BIN_NUMBER = "123123";
  ...
  public static final Double TOTAL_DISCOUNT = 20000.00;
  public static final Double TOTAL_PRICE = 200000.00;
  ...
  public static String CODE = "PROMOCODEAPPLY";
  ...
  private static PaymentDTO getPaymentDTO() {
    ...
    paymentDTO.setBinNumber(BIN_NUMBER);
  ...
  public static final CalculationResult CALCULATION_RESULT = new CalculationResultBuilder()
      ...
      .withTotalDiscount(TOTAL_DISCOUNT)
