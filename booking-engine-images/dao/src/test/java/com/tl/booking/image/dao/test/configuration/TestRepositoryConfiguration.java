package com.tl.booking.image.dao.test.configuration;
...
@Configuration
@EnableMongoRepositories(basePackages = {"com.tl.booking.image.entity",
    "com.tl.booking.promo.list.dao"})
@EnableMongoAuditing(auditorAwareRef = "stringAuditorAware")
@ComponentScan(basePackages = {"com.tl.booking.image.entity",
    "com.tl.booking.promo.list.dao"})
public class TestRepositoryConfiguration extends AbstractMongoConfiguration {
  ...
  private static final String ENTITY = "com.tl.booking.image.entity";
