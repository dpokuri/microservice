package com.tl.booking.gateway.dao.test.configuration;
...
@Configuration
@EnableMongoRepositories(basePackages = {"com.tl.booking.gateway.entity",
    "com.tl.booking.gateway.dao"})
@EnableMongoAuditing(auditorAwareRef = "stringAuditorAware")
@ComponentScan(basePackages = {"com.tl.booking.gateway.entity",
    "com.tl.booking.gateway.dao"})
public class TestRepositoryConfiguration extends AbstractMongoConfiguration {
  ...
  private static final String ENTITY = "com.tl.booking.gateway.entity";
