...
import com.tl.booking.gateway.rest.web.controller.promocode.PaymentController;
...
public class PaymentControllerTest {
  ...
  public void binNumberTest() throws Exception {
    ...
    when(this.paymentService.payment(
        CommonTestVariable.MANDATORY_REQUEST,
        PaymentTestVariable.PRIVILEGES,
        CommonTestVariable.SESSION_DATA)).thenReturn(Single.just(PaymentTestVariable.PAYMENT_RESPONSE_LIST));


    MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
        .get(ApiPath.PAYMENT + "/findAll")
    ...
    verify(this.paymentService).payment(
        CommonTestVariable.MANDATORY_REQUEST,
        PaymentTestVariable.PRIVILEGES,
