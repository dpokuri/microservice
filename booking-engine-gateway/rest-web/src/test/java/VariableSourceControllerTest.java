...
import com.tl.booking.gateway.rest.web.controller.promocode.VariableSourceController;
...
public class VariableSourceControllerTest {
  ...
  public void binNumberTest() throws Exception {
    ...
    when(this.variableSourceService.findAllVariableSource(
        ...
        CommonTestVariable.SESSION_DATA)).thenReturn(Single.just(VariableSourceTestVariable.VARIABLE_SOURCE_RESPONSE_LIST));


    MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
        .get(ApiPath.VARIABLE_SOURCE + "/{sourceType}", VariableSourceTestVariable.SOURCE_TYPE)
        ...
        .param("key", VariableSourceTestVariable.KEY);
    ...
    verify(this.variableSourceService).findAllVariableSource(
        CommonTestVariable.MANDATORY_REQUEST,
        VariableSourceTestVariable.SOURCE_TYPE,
        VariableSourceTestVariable.KEY,
        VariableSourceTestVariable.PRIVILEGES,
  ...
  public void setUp() throws Exception {
    ...
    this.mockMvc = MockMvcBuilders.standaloneSetup(this.variableSourceController).build();
  }

  @After
  public void tearDown() throws Exception {
    verifyNoMoreInteractions(this.variableSourceService);
  }
}
