...
import com.tl.booking.gateway.rest.web.controller.promocode.ChannelIdController;
...
public class ChannelIdControllerTest {
  ...
  public void binNumberTest() throws Exception {
    ...
    when(this.channelIdService.findAllChannelId(
        CommonTestVariable.MANDATORY_REQUEST,
        ChannelIdTestVariable.PRIVILEGES,
        CommonTestVariable.SESSION_DATA)).thenReturn(Single.just(ChannelIdTestVariable.CHANNEL_ID_RESPONSE_LIST));


    MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
        .get(ApiPath.CHANNEL_ID + "/findAll")
    ...
    verify(this.channelIdService).findAllChannelId(
        CommonTestVariable.MANDATORY_REQUEST,
        ChannelIdTestVariable.PRIVILEGES,
  ...
  public void setUp() throws Exception {
    ...
    this.mockMvc = MockMvcBuilders.standaloneSetup(this.channelIdController).build();
  }

  @After
  public void tearDown() throws Exception {
    verifyNoMoreInteractions(this.channelIdService);
  }
}
