...
import com.tl.booking.gateway.rest.web.controller.promocode.StoreIdController;
...
public class StoreIdControllerTest {

  @InjectMocks
  StoreIdController paymentController;

  @Mock
  StoreIdService paymentService;
  ...
  public void binNumberTest() throws Exception {
    ...
    when(this.paymentService.findStoreId(
        CommonTestVariable.MANDATORY_REQUEST,
        StoreIdTestVariable.PRIVILEGES,
        CommonTestVariable.SESSION_DATA)).thenReturn(Single.just(StoreIdTestVariable.STORE_ID_RESPONSE_LIST));


    MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
        .get(ApiPath.STORE_ID + "/findAll")
    ...
    verify(this.paymentService).findStoreId(
        CommonTestVariable.MANDATORY_REQUEST,
        StoreIdTestVariable.PRIVILEGES,
