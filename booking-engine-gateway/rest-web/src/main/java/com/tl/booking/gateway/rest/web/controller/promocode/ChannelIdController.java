...
@RestController
@RequestMapping(ApiPath.CHANNEL_ID)
@Api(value = "ChannelId")
public class ChannelIdController {
  ...
  public DeferredResult<GatewayBaseResponse<List<ChannelIdResponse>>> findChannelIds() {

    DeferredResult<GatewayBaseResponse<List<ChannelIdResponse>>> deferred = new DeferredResult<>();
    ...
    this.channelIdService.findAllChannelId(mandatoryRequest, (String) MDC.get
