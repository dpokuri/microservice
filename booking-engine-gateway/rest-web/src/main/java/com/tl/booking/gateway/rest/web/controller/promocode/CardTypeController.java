...
@RestController
@RequestMapping(ApiPath.CARD_TYPE)
@Api(value = "CardType")
public class CardTypeController {
  ...
  public DeferredResult<GatewayBaseResponse<List<CardTypeResponse>>> findCardTypes() {

    DeferredResult<GatewayBaseResponse<List<CardTypeResponse>>> deferred = new DeferredResult<>();
    ...
    this.cardTypeService.findAllCardType(mandatoryRequest, (String) MDC.get
