...
@RestController
@RequestMapping(ApiPath.STORE_ID)
@Api(value = "StoreId")
public class StoreIdController {
  ...
  public DeferredResult<GatewayBaseResponse<List<StoreIdResponse>>> findStoreIds() {

    DeferredResult<GatewayBaseResponse<List<StoreIdResponse>>> deferred = new DeferredResult<>();
    ...
    this.storeIdService.findStoreId(mandatoryRequest, (String) MDC.get
